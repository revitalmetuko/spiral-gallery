...
const RecruitmentPreparationLecture = () => {
  ...
  return (
    ...
    פעילויות מרכזיות שביצעתי במסגרת התוכנית שיזמתי 
        ...
        <br />
        ויטל ליוותה באופן אישי כ-40 נערים ונערות בתהליך זה.
         היוזמה זכתה למשוב חיובי ממשתתפים והובילה לגיוס של מרבית המשתתפים בתפקידים טכנולוגים בצה"ל.
        <br /><br />
        בוסף לכך אני מלווה כשלוש שנים ביחידת מגשימים ומלווה מאות בני נוער מסייעת להם להגיע לתפקידים בצה"ל. מייעצת ומבינה. להלן כמה פידבקים מתוכנית Tech it ומלשבים שלוויתי. מוזמנים לפנות לתיאום הרצאה בנושא.
