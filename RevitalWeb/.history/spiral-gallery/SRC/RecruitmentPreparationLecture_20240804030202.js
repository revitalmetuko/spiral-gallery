  ...
  return (
    <div style={{ padding: '16px' }}>
      ...
      <Typography variant="body1" align="right" paragraph>
        ...
        יוזמה קהילתית שהוקמה לפני כשלוש שנים  על ידי, אחותי ושלוש חברות נוספות, במטרה לגשר על הפער בחינוך הטכנולוגי לנוער יוצאי אתיופיה בישראל. הפרויקט שואף להנגיש ידע והזדמנויות בתחום הטכנולוגי לצעירים לפני שירותם הצבאי, עם דגש על הכנה לתפקידים טכנולוגיים בצה"ל.
