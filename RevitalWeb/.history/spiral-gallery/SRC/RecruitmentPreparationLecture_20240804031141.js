  ...
  return (
    <div style={{ padding: '16px' }}>
      ...
      <Typography variant="body1" align="right" paragraph>
        אני רויטל מתוקו, מייסדת ומנהלת תוכנית TECH IT, יוזמה קהילתית שהוקמה לפני כשלוש שנים בהובלתי ועוד מתנדבות,
        במטרה לגשר על הפער בחינוך הטכנולוגי לנוער יוצאי אתיופיה בישראל. הפרויקט שואף להנגיש ידע והזדמנויות בתחום הטכנולוגי לצעירים לפני שירותם הצבאי, עם דגש על הכנה לתפקידים טכנולוגיים בצה"ל.
        היוזמה נולדה מתוך הבנה שהצבא משמש כפלטפורמה משמעותית לשינוי חברתי והעצמה.
        <br /><br />
        פעילויות מרכזיות שביצעתי במסגרת התוכנית שיזמתי:
        <br />
        1. סדנאות וסמינרים: מארגנים סדנאות וסמינרים עם אנשי מקצוע מהתעשייה ובוגרי יחידות טכנולוגיות בצה"ל שמספרים על ניסיונם ומספקים הדרכה על מסלולי הקריירה הטכנולוגיים. משתתפים בולטים כוללים את מאור שלמה, מנכ"ל אקספלוריום, משה זיני, מגייס מייקרוסופט ובוגרי 8200.
        <br />
        ויטל ליוותה באופן אישי כ-40 נערים ונערות בתהליך זה. היוזמה זכתה למשוב חיובי ממשתתפים והובילה לגיוס של מרבית המשתתפים בתפקידים טכנולוגיים בצה"ל.
        <br /><br />
        בנוסף לכך אני מלווה כשלוש שנים ביחידת מגשימים ומלווה מאות בני נוער מסייעת להם להגיע לתפקידים בצה"ל. מייעצת ומבינה. להלן כמה פידבקים מתוכנית Tech it ומלשבים שלוויתי. מוזמנים לפנות אלי לתיאום הרצאה בנושא ואעזור לכם או לילדכם להגיע לתפקיד המתאים לו.
      </Typography>
